...
if (!document.getElementById('devfloat-extension-root')) {
  const initExtension = async (): Promise<void> => {
    const zIndex = 999999
    const zIndexFront = 2147483646
    ...
    passThrough.id = 'devfloat-extension-root'
    ...
    const bringToFront = (): void => {
      passThrough.style.zIndex = String(zIndexFront)
      appRoot.style.zIndex = String(zIndexFront)
    }
